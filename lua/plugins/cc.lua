return {
	...
	config = function()
				...
				adapters = {
					anthropic = function()
						return require("codecompanion.adapters").extend("anthropic", {
							env = {
								api_key = "cmd:dcli read dl://ANTHROPIC_API_KEY/content",
							},
							schema = {
								model = {
					...
					openai = function()
						return require("codecompanion.adapters").extend("openai", {
							name = "gpt",
							env = {
								api_key = "cmd:dcli read dl://OPENAI_API_KEY/content",
							},
							schema = {
								model = {
									default = "gpt-4.1",
		...
		vim.api.nvim_set_keymap(
			...
			{ noremap = true, silent = true, desc = "toggle CodeCompanionChat window" }
		)
		vim.api.nvim_set_keymap(
			"v",
			"<leader>cc",
